...
#
    ...
    logistic_model_student_only <- glm(default ~ student, data = Default, family = binomial)

    # 比较两个模型的 AIC 和 BIC
    AIC(logistic_model, logistic_model_student_only)
    BIC(logistic_model, logistic_model_student_only)
